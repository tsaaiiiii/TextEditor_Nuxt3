...
const revive_payload_server_uK4JRqWorm = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_qW7RMsb0Ez = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b7f3a15d.js").then((m) => m.default || m)
  }
];
...
const vueInject_ft8CTCqJDa = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(VueDOMPurifyHTML);
});
const _plugins = [
  revive_payload_server_uK4JRqWorm,
  components_plugin_KR1HBZs4kY,
  unhead_qW7RMsb0Ez,
  plugin,
  vueInject_ft8CTCqJDa
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-1f84e613.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-3ee2edb5.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.5.2_@types+node@18.0.0_eslint@8.42.0_less@4.1.3_sass@1.62.1_typescript@5.0.4_vue-tsc@1.6.5/node_modules/nuxt/dist/app/components/nuxt-root.vue");
