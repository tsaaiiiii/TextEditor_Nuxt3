...
const error404_vue_vue_type_style_index_0_scoped_71447f4e_lang = "";
const _sfc_main = {
  __name: "error-404",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-71447f4e><div class="fixed left-0 right-0 spotlight z-10" data-v-71447f4e></div><div class="max-w-520px text-center z-20" data-v-71447f4e><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-71447f4e>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-71447f4e>${ssrInterpolate(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-71447f4e>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-71447f4e"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-d8c182d8.js.map
